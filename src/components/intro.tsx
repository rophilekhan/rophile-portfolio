...
const skills = [
    "HTML", "CSS", "JavaScript", "TypeScript", "Bootstrap 5",
    "Tailwind", "Next.js", "Node.js", "React.js", "React Native",
    ".NET", "MVC 5", "SQL", "Telerik", "Git", "Redux Toolkit", "Framer Motion"
]
...
export default function Intro() {
  ...
  const [mounted, setMounted] = useState(false) // Hydration fix ke liye state

  useEffect(() => {
    setMounted(true) // Component mount hone ke baad hi true hoga
  ...
  // Jab tak client par mount na ho jaye, tab tak hydration mismatch se bachne ke liye null return karein
  if (!mounted) {
    return null
  }
        ...
        >
          ...
          >
            <Link
              ...
              className="bg-purple-600 hover:bg-purple-700 text-white px-7
               py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110
               dark:bg-purple-600 active:scale-105 transition"
            >
